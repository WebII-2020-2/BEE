  ...
  return (
    <Col sm md={4} lg={3} className={`admin-sidebar wide ${disabled && 'disabled'}`}>
      <Nav className="admin-sidebar">
        ...
        <Nav.Link className={`admin-sidebar-link ${link === 'produtos' && 'selected'}`} disabled={link === 'produtos'} href="/admin/produtos">Produtos</Nav.Link>
        <Nav.Link className={`admin-sidebar-link ${link === 'categorias' && 'selected'}`} disabled={link === 'categorias'} href="/admin/categorias">Categorias</Nav.Link>
        <Nav.Link className={`admin-sidebar-link ${link === 'promocoes' && 'selected'}`} disabled={link === 'promocoes'} href="/admin/promoções">Promoções</Nav.Link>
        <Nav.Link className={`admin-sidebar-link ${link === 'vendas' && 'selected'}`} disabled={link === 'vendas'} href="/admin/vendas">Vendas</Nav.Link>
        <Nav.Link className={`admin-sidebar-link ${link === 'relatorios' && 'selected'}`} disabled={link === 'relatorios'} href="/admin/relatorios">Relatórios</Nav.Link>
